...
public class CommentExpandAdapter extends BaseExpandableListAdapter {
    ...
    private List<com.google.blockly.android.demo.CommentDetailBean> commentBeanList;
    private List<ReplyDetailBean> replyBeanList;
    private Context context;
    private int pageIndex = 1;

    public CommentExpandAdapter(Context context, List<com.google.blockly.android.demo.CommentDetailBean> commentBeanList) {
     ...
     */
    public void addTheCommentData(com.google.blockly.android.demo.CommentDetailBean commentDetailBean){
