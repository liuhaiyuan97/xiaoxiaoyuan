...
public class HorizontalSlowScrollView extends HorizontalScrollView {
    private Scroller mScroller;


    public HorizontalSlowScrollView(Context context) {
        super(context);
        mScroller = new Scroller(context);
    }

    public HorizontalSlowScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mScroller = new Scroller(context);
    }

    public HorizontalSlowScrollView(Context context, AttributeSet attrs, int defStyle) {
